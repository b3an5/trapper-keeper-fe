  ...
  render() {
    ...
    return (
      <section className="form">
        <button className="delete-list-btn" onClick={this.handleDelete}>
          Delete List
        </button>
        ...
        <button className="cancel-btn" onClick={this.handleRedirect}>
          Cancel
        </button>
        <button className="save-btn" onClick={this.createNote}>
          Save
        </button>
      </section>
    )
